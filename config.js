...
BOT_NAME: process.env.BOT_NAME || "PAK CYBER BOT",
// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "PAK CYBER",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "923348544535",
// add your bot owner number
OWNER_NAME: process.env.OWNER_NAME || "ADMIN ABDULLAH ASAD",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ADMIS*",
// add bot owner name    
